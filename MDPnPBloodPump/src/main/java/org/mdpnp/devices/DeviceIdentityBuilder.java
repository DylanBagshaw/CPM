...
public class DeviceIdentityBuilder {
	...
	public DeviceIdentityBuilder osName() {
		...
		if (maxOperatingSystemLength > 0) {
			...
			String operatingSystem = osName + " " + System.getProperty("os.arch") + " "
	...
	public DeviceIdentityBuilder withIcon(Class<? extends Object> dev, String iconResourceName) {
		try {
	...
	// added type argument to Class
	private boolean iconFromResource(Class<? extends Object> dev, String iconResourceName) throws IOException {
