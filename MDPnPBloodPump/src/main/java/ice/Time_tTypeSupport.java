 ...
 * Time_t.
 */
public class Time_tTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::Time_t";
    ...
    private static final Time_tTypeSupport _singleton
        = new Time_tTypeSupport();
     ...
     */
    public static Time_tTypeSupport get_instance() {
        return _singleton;
    }

    public static Time_tTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return Time_t.create();
    }
     ...
     * <code>this</code> is not a <code>Time_t</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        Time_t typedDst = (Time_t) destination;
        Time_t typedSrc = (Time_t) source;
...
Time_t typedSrc = (Time_t) src;    
        ...
        dst.writeInt(typedSrc.sec);        
            
        dst.writeInt(typedSrc.nanosec);        
...
Time_t typedDst = (Time_t) dst;
        
            typedDst.clear();
    try {

            typedDst.sec = src.readInt();
            
            typedDst.nanosec = src.readInt();
...
Time_t typedDst = (Time_t) sample;
    ...
    protected Time_tTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,Time_tTypeCode.VALUE,Time_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected Time_tTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,Time_tTypeCode.VALUE,Time_t.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
