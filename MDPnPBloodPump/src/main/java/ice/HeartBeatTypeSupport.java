 ...
 * HeartBeat.
 */
public class HeartBeatTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::HeartBeat";
    ...
    private static final HeartBeatTypeSupport _singleton
        = new HeartBeatTypeSupport();
     ...
     */
    public static HeartBeatTypeSupport get_instance() {
        return _singleton;
    }

    public static HeartBeatTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>HeartBeat</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        HeartBeat typedDst = (HeartBeat) destination;
        HeartBeat typedSrc = (HeartBeat) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        HeartBeat typedSrc = (HeartBeat) sample;
...
HeartBeat typedSrc = (HeartBeat) src;    
        ...
        dst.writeString(typedSrc.type,(32));
...
HeartBeat typedDst = (HeartBeat) dst;
    ...
    try {
            ...
            typedDst.type = src.readString((32));
...
HeartBeat typedDst = (HeartBeat) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
HeartBeat typedDst = (HeartBeat) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new HeartBeatDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new HeartBeatDataReader(native_reader, listener, mask, this);                
    ...
    protected HeartBeatTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,HeartBeatTypeCode.VALUE,HeartBeat.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected HeartBeatTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,HeartBeatTypeCode.VALUE,HeartBeat.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
