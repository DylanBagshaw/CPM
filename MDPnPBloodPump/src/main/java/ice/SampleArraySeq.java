...
/**
 * A sequence of SampleArray instances.
 */
public final class SampleArraySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public SampleArraySeq() {
        super(SampleArray.class);
    }


    public SampleArraySeq(int initialMaximum) {
        super(SampleArray.class, initialMaximum);
    }


    public SampleArraySeq(Collection elements) {
        super(SampleArray.class, elements);
    }
