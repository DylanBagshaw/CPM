...
/**
 * A sequence of Alert instances.
 */
public final class AlertSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public AlertSeq(int initialMaximum) {
        super(Alert.class, initialMaximum);
    }


    public AlertSeq(Collection elements) {
        super(Alert.class, elements);
    }
    ...
    public Object copy_from(Object src) {
        ...
        // copy 'new' Alert objects (beyond the original size of this object)
