...
public class ImageTypeSupport extends TypeSupportImpl {
    ...
    private static final ImageTypeSupport _singleton
        = new ImageTypeSupport();
     ...
     * <code>this</code> is not a <code>Image</code>
     * type.
     */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ice.ImageDataTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ice.ImageDataTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        currentAlignment += ice.ImageDataTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.image);
...
Image typedSrc = (Image) src;    
        ...
        ice.ImageDataTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.image, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
Image typedDst = (Image) dst;
    ...
    try {
            ...
            typedDst.image = (ice.ImageData)ice.ImageDataTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.image, src, false, true, endpoint_plugin_qos);            
...
Image typedDst = (Image) sample;
    ...
    protected ImageTypeSupport(boolean enableKeySupport) {
        ...
        super(TYPE_NAME, enableKeySupport,ImageTypeCode.VALUE,Image.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
