...
/**
 * A sequence of DeviceIdentity instances.
 */
public final class DeviceIdentitySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public DeviceIdentitySeq() {
        super(DeviceIdentity.class);
    }


    public DeviceIdentitySeq(int initialMaximum) {
        super(DeviceIdentity.class, initialMaximum);
    }


    public DeviceIdentitySeq(Collection elements) {
        super(DeviceIdentity.class, elements);
    }
