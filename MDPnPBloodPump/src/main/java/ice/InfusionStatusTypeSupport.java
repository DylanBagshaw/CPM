 ...
 * InfusionStatus.
 */
public class InfusionStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::InfusionStatus";
    ...
    private static final InfusionStatusTypeSupport _singleton
        = new InfusionStatusTypeSupport();
     ...
     */
    public static InfusionStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static InfusionStatusTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return InfusionStatus.create();
    }
     ...
     * <code>this</code> is not a <code>InfusionStatus</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        InfusionStatus typedDst = (InfusionStatus) destination;
        InfusionStatus typedSrc = (InfusionStatus) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        InfusionStatus typedSrc = (InfusionStatus) sample;
        ...
        currentAlignment += CdrPrimitiveType.getWstringSerializedSize(currentAlignment, typedSrc.drug_name);
...
InfusionStatus typedSrc = (InfusionStatus) src;    
        ...
        dst.writeBoolean(typedSrc.infusionActive);        
            
        dst.writeWstring(typedSrc.drug_name,(128));                                     
            
        dst.writeInt(typedSrc.drug_mass_mcg);        
            
        dst.writeInt(typedSrc.solution_volume_ml);        
            
        dst.writeInt(typedSrc.volume_to_be_infused_ml);        
            
        dst.writeInt(typedSrc.infusion_duration_seconds);        
            
        dst.writeFloat(typedSrc.infusion_fraction_complete);        
...
InfusionStatus typedDst = (InfusionStatus) dst;
    ...
    try {
            ...
            typedDst.infusionActive = src.readBoolean();
            
            typedDst.drug_name = src.readWstring((128));
            
            typedDst.drug_mass_mcg = src.readInt();
            
            typedDst.solution_volume_ml = src.readInt();
            
            typedDst.volume_to_be_infused_ml = src.readInt();
            
            typedDst.infusion_duration_seconds = src.readInt();
            
            typedDst.infusion_fraction_complete = src.readFloat();
...
InfusionStatus typedDst = (InfusionStatus) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
InfusionStatus typedDst = (InfusionStatus) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        InfusionStatus typedDst
            = (InfusionStatus) instance;
        InfusionStatus typedSrc
            = (InfusionStatus) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new InfusionStatusDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new InfusionStatusDataReader(native_reader, listener, mask, this);                
    ...
    protected InfusionStatusTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,InfusionStatusTypeCode.VALUE,InfusionStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected InfusionStatusTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,InfusionStatusTypeCode.VALUE,InfusionStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
