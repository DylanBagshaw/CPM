 ...
 * MDSConnectivityObjective.
 */
public class MDSConnectivityObjectiveTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::MDSConnectivityObjective";
    ...
    private static final MDSConnectivityObjectiveTypeSupport _singleton
        = new MDSConnectivityObjectiveTypeSupport();
     ...
     */
    public static MDSConnectivityObjectiveTypeSupport get_instance() {
        return _singleton;
    }

    public static MDSConnectivityObjectiveTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return MDSConnectivityObjective.create();
    }
    ...
    public Object create_key() {
        return new MDSConnectivityObjective();
    }
    ...
    public Class get_type() {
        return MDSConnectivityObjective.class;
    }
     ...
     * <code>this</code> is not a <code>MDSConnectivityObjective</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        MDSConnectivityObjective typedDst = (MDSConnectivityObjective) destination;
        MDSConnectivityObjective typedSrc = (MDSConnectivityObjective) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        MDSConnectivityObjective typedSrc = (MDSConnectivityObjective) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.partition);
...
MDSConnectivityObjective typedSrc = (MDSConnectivityObjective) src;    
        ...
        dst.writeString(typedSrc.partition,(128));
...
MDSConnectivityObjective typedDst = (MDSConnectivityObjective) dst;
...
MDSConnectivityObjective typedDst = (MDSConnectivityObjective) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
MDSConnectivityObjective typedDst = (MDSConnectivityObjective) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        MDSConnectivityObjective typedDst
            = (MDSConnectivityObjective) instance;
        MDSConnectivityObjective typedSrc
            = (MDSConnectivityObjective) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new MDSConnectivityObjectiveDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new MDSConnectivityObjectiveDataReader(native_reader, listener, mask, this);                
    ...
    protected MDSConnectivityObjectiveTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,MDSConnectivityObjectiveTypeCode.VALUE,MDSConnectivityObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected MDSConnectivityObjectiveTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,MDSConnectivityObjectiveTypeCode.VALUE,MDSConnectivityObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
