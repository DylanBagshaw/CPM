...
/**
 * A sequence of AlarmLimit instances.
 */
public final class AlarmLimitSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public AlarmLimitSeq() {
        super(AlarmLimit.class);
    }


    public AlarmLimitSeq(int initialMaximum) {
        super(AlarmLimit.class, initialMaximum);
    }


    public AlarmLimitSeq(Collection elements) {
        super(AlarmLimit.class, elements);
    }
