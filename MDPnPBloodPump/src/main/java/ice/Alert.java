...
public class Alert implements Copyable, Serializable
{

    public String unique_device_identifier = ""; /* maximum length = (64) */
    public String identifier = ""; /* maximum length = (256) */
    public String text = ""; /* maximum length = (256) */
    ...
    public boolean equals(Object o) {
        ...
        if(!identifier.equals(otherObj.identifier)) {
            return false;
        }
     ...
     * This method could be placed into <code>AlertTypeSupport</code>
    ...
    public Object copy_from(Object src) {
        ...
        typedDst.identifier = typedSrc.identifier;
    ...
    public String toString(String desc, int indent) {
        ...
        CdrHelper.printIndent(strBuffer, indent+1);            
        strBuffer.append("identifier: ").append(identifier).append("\n");
