...
public class BypassStatusTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[i]=new StructMember("bypass_flow_lmin",false,(short)-1,false,(TypeCode)TypeCode.TC_LONG,2,false); i++;
        sm[i]=new StructMember("bypass_speed_rpm",false,(short)-1,false,(TypeCode)TypeCode.TC_LONG,3,false); i++;
        sm[i]=new StructMember("blood_temp_celsius",false,(short)-1,false,(TypeCode)TypeCode.TC_LONG,4,false); i++;
        sm[i]=new StructMember("blood_press_hhmg",false,(short)-1,false,(TypeCode)TypeCode.TC_LONG,5,false); i++;
        sm[i]=new StructMember("volume_bypassed_ml",false,(short)-1,false,(TypeCode)TypeCode.TC_LONG,6,false); i++;
