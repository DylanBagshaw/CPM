 ...
 * LimitType.
 */
public class LimitTypeTypeSupport extends TypeSupportImpl {    
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::LimitType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    private static final LimitTypeTypeSupport _singleton
        = new LimitTypeTypeSupport();    
    ...
    public static LimitTypeTypeSupport get_instance() {
        return _singleton;
    }

    /* deprecated API */
    public static LimitTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * So, for example:
     *    myEnumField = LimitTypeTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst, boolean serialize_encapsulation, short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
LimitType typedSrc = (LimitType) src;   
    ...
    protected LimitTypeTypeSupport() {
        
            super(TYPE_NAME, false /*no key*/,LimitTypeTypeCode.VALUE,LimitType.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
