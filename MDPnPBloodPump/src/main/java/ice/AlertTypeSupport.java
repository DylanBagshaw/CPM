 ...
 * Alert.
 */
public class AlertTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::Alert";
    ...
    private static final AlertTypeSupport _singleton
        = new AlertTypeSupport();
     ...
     */
    public static AlertTypeSupport get_instance() {
        return _singleton;
    }

    public static AlertTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>Alert</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        Alert typedDst = (Alert) destination;
        Alert typedSrc = (Alert) source;
	...
	Object sample) 
    {
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.identifier);
...
Alert typedSrc = (Alert) src;    
        ...
        dst.writeString(typedSrc.identifier,(256));
            
        dst.writeString(typedSrc.text,(256));
...
Alert typedDst = (Alert) dst;
    ...
    try {
            ...
            typedDst.identifier = src.readString((256));
            
            typedDst.text = src.readString((256));
...
Alert typedDst = (Alert) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new AlertDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new AlertDataReader(native_reader, listener, mask, this);                
    ...
    protected AlertTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,AlertTypeCode.VALUE,Alert.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected AlertTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,AlertTypeCode.VALUE,Alert.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
