...
/**
 * A sequence of ValidTargets instances.
 */
public final class ValidTargetsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public ValidTargetsSeq() {
        super(ValidTargets.class);
    }


    public ValidTargetsSeq(int initialMaximum) {
        super(ValidTargets.class, initialMaximum);
    }


    public ValidTargetsSeq(Collection elements) {
        super(ValidTargets.class, elements);
    }
