 ...
 * Values.
 */
public class ValuesTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::Values";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final ValuesTypeSupport _singleton
        = new ValuesTypeSupport();
     ...
     */
    public static ValuesTypeSupport get_instance() {
        return _singleton;
    }

    public static ValuesTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>Values</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        Values typedDst = (Values) destination;
        Values typedSrc = (Values) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.FLOAT.getSequenceMaxSizeSerialized(currentAlignment, (1024));
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.FLOAT.getSequenceMaxSizeSerialized(currentAlignment, 0);
	...
	Object sample) 
    {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getSequenceSerializedSize(currentAlignment, typedSrc.userData);
...
Values typedSrc = (Values) src;    
        ...
        dst.writeFloatSeq(typedSrc.userData,(1024));
...
Values typedDst = (Values) dst;
        
            typedDst.clear();
            src.readFloatSequence(
                typedDst.userData,
                (1024));
...
Values typedDst = (Values) sample;
    ...
    protected ValuesTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ValuesTypeCode.VALUE,Values.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected ValuesTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,ValuesTypeCode.VALUE,Values.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
