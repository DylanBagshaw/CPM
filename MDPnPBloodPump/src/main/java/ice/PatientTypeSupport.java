 ...
 * Patient.
 */
public class PatientTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::Patient";
    ...
    private static final PatientTypeSupport _singleton
        = new PatientTypeSupport();
     ...
     */
    public static PatientTypeSupport get_instance() {
        return _singleton;
    }

    public static PatientTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>Patient</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        Patient typedDst = (Patient) destination;
        Patient typedSrc = (Patient) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((16)) + 1);
            
        currentAlignment +=  CdrPrimitiveType.getWstringMaxSizeSerialized(currentAlignment, ((256)) + 1);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        Patient typedSrc = (Patient) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.mrn);
            
        currentAlignment += CdrPrimitiveType.getWstringSerializedSize(currentAlignment, typedSrc.given_name);
            
        currentAlignment += CdrPrimitiveType.getWstringSerializedSize(currentAlignment, typedSrc.family_name);
...
Patient typedSrc = (Patient) src;    
        ...
        dst.writeString(typedSrc.mrn,(16));
            
        dst.writeWstring(typedSrc.given_name,(256));                                     
            
        dst.writeWstring(typedSrc.family_name,(256));                                     
...
Patient typedDst = (Patient) dst;
        
            typedDst.clear();
    try {

            typedDst.mrn = src.readString((16));
            
            typedDst.given_name = src.readWstring((256));
            
            typedDst.family_name = src.readWstring((256));
...
Patient typedDst = (Patient) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
Patient typedDst = (Patient) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new PatientDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new PatientDataReader(native_reader, listener, mask, this);                
    ...
    protected PatientTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,PatientTypeCode.VALUE,Patient.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected PatientTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,PatientTypeCode.VALUE,Patient.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
