...
/**
 * A sequence of BypassObjective instances.
 */
public final class BypassObjectiveSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public BypassObjectiveSeq() {
        super(BypassObjective.class);
    }


    public BypassObjectiveSeq(int initialMaximum) {
        super(BypassObjective.class, initialMaximum);
    }


    public BypassObjectiveSeq(Collection elements) {
        super(BypassObjective.class, elements);
    }
