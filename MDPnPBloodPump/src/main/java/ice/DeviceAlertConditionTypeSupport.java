 ...
 */
public class DeviceAlertConditionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::DeviceAlertCondition";
    ...
    private static final DeviceAlertConditionTypeSupport _singleton
        = new DeviceAlertConditionTypeSupport();
     ...
     */
    public static DeviceAlertConditionTypeSupport get_instance() {
        return _singleton;
    }

    public static DeviceAlertConditionTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return DeviceAlertCondition.create();
    }
    ...
    public Object create_key() {
        return new DeviceAlertCondition();
    }
     ...
     * <code>this</code> is not a <code>DeviceAlertCondition</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        DeviceAlertCondition typedDst = (DeviceAlertCondition) destination;
        DeviceAlertCondition typedSrc = (DeviceAlertCondition) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((256)) + 1);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        DeviceAlertCondition typedSrc = (DeviceAlertCondition) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.alert_state);
...
DeviceAlertCondition typedSrc = (DeviceAlertCondition) src;    
        ...
        dst.writeString(typedSrc.alert_state,(256));
...
DeviceAlertCondition typedDst = (DeviceAlertCondition) dst;
    ...
    try {
            ...
            typedDst.alert_state = src.readString((256));
...
DeviceAlertCondition typedDst = (DeviceAlertCondition) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
DeviceAlertCondition typedDst = (DeviceAlertCondition) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        DeviceAlertCondition typedDst
            = (DeviceAlertCondition) instance;
        DeviceAlertCondition typedSrc
            = (DeviceAlertCondition) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new DeviceAlertConditionDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new DeviceAlertConditionDataReader(native_reader, listener, mask, this);                
    ...
    protected DeviceAlertConditionTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,DeviceAlertConditionTypeCode.VALUE,DeviceAlertCondition.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected DeviceAlertConditionTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,DeviceAlertConditionTypeCode.VALUE,DeviceAlertCondition.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
