 ...
 * MetricIdentifier.
 */
public class MetricIdentifierTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::MetricIdentifier";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final MetricIdentifierTypeSupport _singleton
        = new MetricIdentifierTypeSupport();
     ...
     */
    public static MetricIdentifierTypeSupport get_instance() {
        return _singleton;
    }

    public static MetricIdentifierTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return MetricIdentifier.create();
    }
     ...
     * <code>this</code> is not a <code>MetricIdentifier</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        MetricIdentifier typedDst = (MetricIdentifier) destination;
        MetricIdentifier typedSrc = (MetricIdentifier) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        MetricIdentifier typedSrc = (MetricIdentifier) sample;
...
MetricIdentifier typedDst = (MetricIdentifier) dst;
...
MetricIdentifier typedDst = (MetricIdentifier) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
MetricIdentifier typedDst = (MetricIdentifier) sample;
    ...
    protected MetricIdentifierTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MetricIdentifierTypeCode.VALUE,MetricIdentifier.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected MetricIdentifierTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,MetricIdentifierTypeCode.VALUE,MetricIdentifier.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
