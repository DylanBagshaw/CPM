 ...
 */
public class LocalAlarmLimitObjectiveTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::LocalAlarmLimitObjective";
    ...
    private static final LocalAlarmLimitObjectiveTypeSupport _singleton
        = new LocalAlarmLimitObjectiveTypeSupport();
     ...
     */
    public static LocalAlarmLimitObjectiveTypeSupport get_instance() {
        return _singleton;
    }

    public static LocalAlarmLimitObjectiveTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return LocalAlarmLimitObjective.create();
    }
    ...
    public Object create_key() {
        return new LocalAlarmLimitObjective();
    }
    ...
    public Class get_type() {
        return LocalAlarmLimitObjective.class;
    }
     ...
     * <code>this</code> is not a <code>LocalAlarmLimitObjective</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        LocalAlarmLimitObjective typedDst = (LocalAlarmLimitObjective) destination;
        LocalAlarmLimitObjective typedSrc = (LocalAlarmLimitObjective) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ice.LimitTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ice.LimitTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        LocalAlarmLimitObjective typedSrc = (LocalAlarmLimitObjective) sample;
        ...
        currentAlignment += ice.LimitTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.limit_type);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.unit_identifier);
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment +=  ice.LimitTypeTypeSupport.get_instance().get_serialized_key_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
...
LocalAlarmLimitObjective typedSrc = (LocalAlarmLimitObjective) src;    
        ...
        ice.LimitTypeTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.limit_type, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
            
        dst.writeString(typedSrc.unit_identifier,(64));
...
LocalAlarmLimitObjective typedSrc = (LocalAlarmLimitObjective) src;    
        ...
        ice.LimitTypeTypeSupport.get_instance().serialize_key(endpoint_data,  typedSrc.limit_type, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
LocalAlarmLimitObjective typedDst = (LocalAlarmLimitObjective) dst;
    ...
    try {
            ...
            typedDst.limit_type = (ice.LimitType)ice.LimitTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.limit_type, src, false, true, endpoint_plugin_qos);            
            
            typedDst.unit_identifier = src.readString((64));
...
LocalAlarmLimitObjective typedDst = (LocalAlarmLimitObjective) dst;
            ...
            typedDst.limit_type = (ice.LimitType)ice.LimitTypeTypeSupport.get_instance().deserialize_key_sample(endpoint_data, typedDst.limit_type, src, false, true, endpoint_plugin_qos);            
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            ice.LimitTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
LocalAlarmLimitObjective typedDst = (LocalAlarmLimitObjective) sample;
            ...
            typedDst.limit_type = (ice.LimitType)ice.LimitTypeTypeSupport.get_instance().serialized_sample_to_key(endpoint_data, typedDst.limit_type, src, false, true, endpoint_plugin_qos);            
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        LocalAlarmLimitObjective typedDst
            = (LocalAlarmLimitObjective) instance;
        LocalAlarmLimitObjective typedSrc
            = (LocalAlarmLimitObjective) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new LocalAlarmLimitObjectiveDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new LocalAlarmLimitObjectiveDataReader(native_reader, listener, mask, this);                
    ...
    protected LocalAlarmLimitObjectiveTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,LocalAlarmLimitObjectiveTypeCode.VALUE,LocalAlarmLimitObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected LocalAlarmLimitObjectiveTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,LocalAlarmLimitObjectiveTypeCode.VALUE,LocalAlarmLimitObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
