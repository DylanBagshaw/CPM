...
public class MDSConnectivityObjective implements Copyable, Serializable
{
    ...
    public MDSConnectivityObjective() {

    }


    public MDSConnectivityObjective(MDSConnectivityObjective other) {
    ...
    public static Object create() {
        MDSConnectivityObjective self;
        self = new MDSConnectivityObjective();
    ...
    public boolean equals(Object o) {
        ...
        MDSConnectivityObjective otherObj = (MDSConnectivityObjective)o;
     ...
     * This method could be placed into <code>MDSConnectivityObjectiveTypeSupport</code>
    ...
    public Object copy_from(Object src) {
        ...
        MDSConnectivityObjective typedSrc = (MDSConnectivityObjective) src;
        MDSConnectivityObjective typedDst = this;
