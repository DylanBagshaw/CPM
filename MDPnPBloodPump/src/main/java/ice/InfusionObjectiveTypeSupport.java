 ...
 * InfusionObjective.
 */
public class InfusionObjectiveTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::InfusionObjective";
    ...
    private static final InfusionObjectiveTypeSupport _singleton
        = new InfusionObjectiveTypeSupport();
     ...
     */
    public static InfusionObjectiveTypeSupport get_instance() {
        return _singleton;
    }

    public static InfusionObjectiveTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return InfusionObjective.create();
    }
    ...
    public Class get_type() {
        return InfusionObjective.class;
    }
     ...
     * <code>this</code> is not a <code>InfusionObjective</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        InfusionObjective typedDst = (InfusionObjective) destination;
        InfusionObjective typedSrc = (InfusionObjective) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        InfusionObjective typedSrc = (InfusionObjective) sample;
        ...
        currentAlignment += CdrPrimitiveType.getWstringSerializedSize(currentAlignment, typedSrc.requestor);
...
InfusionObjective typedSrc = (InfusionObjective) src;    
        ...
        dst.writeWstring(typedSrc.requestor,(128));                                     
            
        dst.writeBoolean(typedSrc.stopInfusion);        
...
InfusionObjective typedDst = (InfusionObjective) dst;
    ...
    try {
            ...
            typedDst.requestor = src.readWstring((128));
            
            typedDst.stopInfusion = src.readBoolean();
...
InfusionObjective typedDst = (InfusionObjective) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
InfusionObjective typedDst = (InfusionObjective) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        InfusionObjective typedDst
            = (InfusionObjective) instance;
        InfusionObjective typedSrc
            = (InfusionObjective) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new InfusionObjectiveDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new InfusionObjectiveDataReader(native_reader, listener, mask, this);                
    ...
    protected InfusionObjectiveTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,InfusionObjectiveTypeCode.VALUE,InfusionObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected InfusionObjectiveTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,InfusionObjectiveTypeCode.VALUE,InfusionObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
