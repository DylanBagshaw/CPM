 ...
 * MDSConnectivity.
 */
public class MDSConnectivityTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::MDSConnectivity";
    ...
    private static final MDSConnectivityTypeSupport _singleton
        = new MDSConnectivityTypeSupport();
     ...
     */
    public static MDSConnectivityTypeSupport get_instance() {
        return _singleton;
    }

    public static MDSConnectivityTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return MDSConnectivity.create();
    }
     ...
     * <code>this</code> is not a <code>MDSConnectivity</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        MDSConnectivity typedDst = (MDSConnectivity) destination;
        MDSConnectivity typedSrc = (MDSConnectivity) source;
...
MDSConnectivity typedDst = (MDSConnectivity) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        MDSConnectivity typedDst
            = (MDSConnectivity) instance;
        MDSConnectivity typedSrc
            = (MDSConnectivity) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new MDSConnectivityDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new MDSConnectivityDataReader(native_reader, listener, mask, this);                
    ...
    protected MDSConnectivityTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,MDSConnectivityTypeCode.VALUE,MDSConnectivity.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected MDSConnectivityTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,MDSConnectivityTypeCode.VALUE,MDSConnectivity.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
