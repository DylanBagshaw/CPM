...
/**
 * A sequence of MDSConnectivity instances.
 */
public final class MDSConnectivitySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public MDSConnectivitySeq() {
        super(MDSConnectivity.class);
    }


    public MDSConnectivitySeq(int initialMaximum) {
        super(MDSConnectivity.class, initialMaximum);
    }


    public MDSConnectivitySeq(Collection elements) {
        super(MDSConnectivity.class, elements);
    }
