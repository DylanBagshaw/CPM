 ...
 * VendorMetricIdentifier.
 */
public class VendorMetricIdentifierTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::VendorMetricIdentifier";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final VendorMetricIdentifierTypeSupport _singleton
        = new VendorMetricIdentifierTypeSupport();
     ...
     */
    public static VendorMetricIdentifierTypeSupport get_instance() {
        return _singleton;
    }

    public static VendorMetricIdentifierTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return VendorMetricIdentifier.create();
    }
    ...
    public Object create_key() {
        return new VendorMetricIdentifier();
    }
    ...
    public Class get_type() {
        return VendorMetricIdentifier.class;
    }
     ...
     * <code>this</code> is not a <code>VendorMetricIdentifier</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        VendorMetricIdentifier typedDst = (VendorMetricIdentifier) destination;
        VendorMetricIdentifier typedSrc = (VendorMetricIdentifier) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        VendorMetricIdentifier typedSrc = (VendorMetricIdentifier) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.userData);
...
VendorMetricIdentifier typedSrc = (VendorMetricIdentifier) src;    
        ...
        dst.writeString(typedSrc.userData,(64));
...
VendorMetricIdentifier typedDst = (VendorMetricIdentifier) dst;
        
            typedDst.clear();
            typedDst.userData = src.readString((64));
...
VendorMetricIdentifier typedDst = (VendorMetricIdentifier) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
VendorMetricIdentifier typedDst = (VendorMetricIdentifier) sample;
    ...
    protected VendorMetricIdentifierTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,VendorMetricIdentifierTypeCode.VALUE,VendorMetricIdentifier.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected VendorMetricIdentifierTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,VendorMetricIdentifierTypeCode.VALUE,VendorMetricIdentifier.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
