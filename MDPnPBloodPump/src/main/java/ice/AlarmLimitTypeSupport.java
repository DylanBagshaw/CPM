 ...
 * AlarmLimit.
 */
public class AlarmLimitTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::AlarmLimit";
    ...
    private static final AlarmLimitTypeSupport _singleton
        = new AlarmLimitTypeSupport();
     ...
     */
    public static AlarmLimitTypeSupport get_instance() {
        return _singleton;
    }

    public static AlarmLimitTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return AlarmLimit.create();
    }
     ...
     * <code>this</code> is not a <code>AlarmLimit</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        AlarmLimit typedDst = (AlarmLimit) destination;
        AlarmLimit typedSrc = (AlarmLimit) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        AlarmLimit typedSrc = (AlarmLimit) sample;
...
AlarmLimit typedDst = (AlarmLimit) dst;
...
AlarmLimit typedDst = (AlarmLimit) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
AlarmLimit typedDst = (AlarmLimit) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new AlarmLimitDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new AlarmLimitDataReader(native_reader, listener, mask, this);                
    ...
    protected AlarmLimitTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,AlarmLimitTypeCode.VALUE,AlarmLimit.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected AlarmLimitTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,AlarmLimitTypeCode.VALUE,AlarmLimit.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
