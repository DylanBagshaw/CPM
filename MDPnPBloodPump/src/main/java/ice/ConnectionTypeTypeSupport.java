 ...
 * ConnectionType.
 */
public class ConnectionTypeTypeSupport extends TypeSupportImpl {    
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::ConnectionType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    private static final ConnectionTypeTypeSupport _singleton
        = new ConnectionTypeTypeSupport();    
    ...
    public static ConnectionTypeTypeSupport get_instance() {
        return _singleton;
    }

    /* deprecated API */
    public static ConnectionTypeTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * So, for example:
     *    myEnumField = ConnectionTypeTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst, boolean serialize_encapsulation, short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
ConnectionType typedSrc = (ConnectionType) src;   
    ...
    public Object deserialize_sample(
        ...
        if(deserialize_sample) {
            ...
            dst = ConnectionType.valueOf(ordinal);
    ...
    protected ConnectionTypeTypeSupport() {
        
            super(TYPE_NAME, false /*no key*/,ConnectionTypeTypeCode.VALUE,ConnectionType.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
