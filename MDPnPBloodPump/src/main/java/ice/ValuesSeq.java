...
/**
 * A sequence of Values instances.
 */
public final class ValuesSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public ValuesSeq(int initialMaximum) {
        super(Values.class, initialMaximum);
    }


    public ValuesSeq(Collection elements) {
        super(Values.class, elements);
    }
    ...
    public Object copy_from(Object src) {
        ...
        // copy 'new' Values objects (beyond the original size of this object)
