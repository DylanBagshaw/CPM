 ...
 * AlarmPriority.
 */
public class AlarmPriorityTypeSupport extends TypeSupportImpl {    
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::AlarmPriority";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    private static final AlarmPriorityTypeSupport _singleton
        = new AlarmPriorityTypeSupport();    
    ...
    public static AlarmPriorityTypeSupport get_instance() {
        return _singleton;
    }

    /* deprecated API */
    public static AlarmPriorityTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * So, for example:
     *    myEnumField = AlarmPriorityTypeSupport.get_instance().copy_data(anotherInstanceOfEnum);
    ...
    public void serialize(Object endpoint_data,Object src, CdrOutputStream dst, boolean serialize_encapsulation, short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
AlarmPriority typedSrc = (AlarmPriority) src;   
    ...
    public Object deserialize_sample(
        ...
        if(deserialize_sample) {
            ...
            dst = AlarmPriority.valueOf(ordinal);
    ...
    protected AlarmPriorityTypeSupport() {
        
            super(TYPE_NAME, false /*no key*/,AlarmPriorityTypeCode.VALUE,AlarmPriority.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
