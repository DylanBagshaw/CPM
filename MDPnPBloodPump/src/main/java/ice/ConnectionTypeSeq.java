...
/**
 * A sequence of ConnectionType instances.
 */
public final class ConnectionTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public ConnectionTypeSeq() {
        super(ConnectionType.class);
    }


    public ConnectionTypeSeq(int initialMaximum) {
        super(ConnectionType.class, initialMaximum);
    }


    public ConnectionTypeSeq(Collection elements) {
        super(ConnectionType.class, elements);
    }
