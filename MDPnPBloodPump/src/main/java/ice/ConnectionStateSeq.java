...
/**
 * A sequence of ConnectionState instances.
 */
public final class ConnectionStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public ConnectionStateSeq() {
        super(ConnectionState.class);
    }


    public ConnectionStateSeq(int initialMaximum) {
        super(ConnectionState.class, initialMaximum);
    }


    public ConnectionStateSeq(Collection elements) {
        super(ConnectionState.class, elements);
    }
