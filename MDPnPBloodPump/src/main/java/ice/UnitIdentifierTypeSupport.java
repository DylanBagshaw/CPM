 ...
 * UnitIdentifier.
 */
public class UnitIdentifierTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::UnitIdentifier";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final UnitIdentifierTypeSupport _singleton
        = new UnitIdentifierTypeSupport();
     ...
     */
    public static UnitIdentifierTypeSupport get_instance() {
        return _singleton;
    }

    public static UnitIdentifierTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return UnitIdentifier.create();
    }
     ...
     * <code>this</code> is not a <code>UnitIdentifier</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        UnitIdentifier typedDst = (UnitIdentifier) destination;
        UnitIdentifier typedSrc = (UnitIdentifier) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        UnitIdentifier typedSrc = (UnitIdentifier) sample;
...
UnitIdentifier typedDst = (UnitIdentifier) dst;
...
UnitIdentifier typedDst = (UnitIdentifier) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
UnitIdentifier typedDst = (UnitIdentifier) sample;
    ...
    protected UnitIdentifierTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UnitIdentifierTypeCode.VALUE,UnitIdentifier.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected UnitIdentifierTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,UnitIdentifierTypeCode.VALUE,UnitIdentifier.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
