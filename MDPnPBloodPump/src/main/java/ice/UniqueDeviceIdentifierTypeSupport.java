 ...
 */
public class UniqueDeviceIdentifierTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::UniqueDeviceIdentifier";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final UniqueDeviceIdentifierTypeSupport _singleton
        = new UniqueDeviceIdentifierTypeSupport();
     ...
     */
    public static UniqueDeviceIdentifierTypeSupport get_instance() {
        return _singleton;
    }

    public static UniqueDeviceIdentifierTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return UniqueDeviceIdentifier.create();
    }
    ...
    public Object create_key() {
        return new UniqueDeviceIdentifier();
    }
    ...
    public Class get_type() {
        return UniqueDeviceIdentifier.class;
    }
     ...
     * <code>this</code> is not a <code>UniqueDeviceIdentifier</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        UniqueDeviceIdentifier typedDst = (UniqueDeviceIdentifier) destination;
        UniqueDeviceIdentifier typedSrc = (UniqueDeviceIdentifier) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        UniqueDeviceIdentifier typedSrc = (UniqueDeviceIdentifier) sample;
...
UniqueDeviceIdentifier typedDst = (UniqueDeviceIdentifier) dst;
...
UniqueDeviceIdentifier typedDst = (UniqueDeviceIdentifier) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
UniqueDeviceIdentifier typedDst = (UniqueDeviceIdentifier) sample;
    ...
    protected UniqueDeviceIdentifierTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UniqueDeviceIdentifierTypeCode.VALUE,UniqueDeviceIdentifier.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected UniqueDeviceIdentifierTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,UniqueDeviceIdentifierTypeCode.VALUE,UniqueDeviceIdentifier.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
