...
/**
 * A sequence of Image instances.
 */
public final class ImageSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public ImageSeq(int initialMaximum) {
        super(Image.class, initialMaximum);
    }


    public ImageSeq(Collection elements) {
        super(Image.class, elements);
    }
    ...
    public Object copy_from(Object src) {
        ...
        // copy 'new' Image objects (beyond the original size of this object)
