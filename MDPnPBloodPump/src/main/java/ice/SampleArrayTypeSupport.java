 ...
 * SampleArray.
 */
public class SampleArrayTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::SampleArray";
    ...
    private static final SampleArrayTypeSupport _singleton
        = new SampleArrayTypeSupport();
     ...
     */
    public static SampleArrayTypeSupport get_instance() {
        return _singleton;
    }

    public static SampleArrayTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return SampleArray.create();
    }
     ...
     * <code>this</code> is not a <code>SampleArray</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        SampleArray typedDst = (SampleArray) destination;
        SampleArray typedSrc = (SampleArray) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ice.ValuesTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
            
        currentAlignment +=  ice.Time_tTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ice.ValuesTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
            
        currentAlignment +=  ice.Time_tTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        SampleArray typedSrc = (SampleArray) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.metric_id);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.vendor_metric_id);
            
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.unit_id);
            
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
            
        currentAlignment += ice.ValuesTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.values);
            
        currentAlignment += ice.Time_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.device_time);
            
        currentAlignment += ice.Time_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.presentation_time);
...
SampleArray typedSrc = (SampleArray) src;    
        ...
        dst.writeString(typedSrc.metric_id,(64));
            
        dst.writeString(typedSrc.vendor_metric_id,(64));
            
        dst.writeInt(typedSrc.instance_id);        
            
        dst.writeString(typedSrc.unit_id,(64));
            
        dst.writeInt(typedSrc.frequency);        
            
        ice.ValuesTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.values, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
            
        ice.Time_tTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.device_time, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
            
        ice.Time_tTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.presentation_time, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
SampleArray typedDst = (SampleArray) dst;
    ...
    try {
            ...
            typedDst.metric_id = src.readString((64));
            
            typedDst.vendor_metric_id = src.readString((64));
            
            typedDst.instance_id = src.readInt();
            
            typedDst.unit_id = src.readString((64));
            
            typedDst.frequency = src.readInt();
            
            typedDst.values = (ice.Values)ice.ValuesTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.values, src, false, true, endpoint_plugin_qos);            
            
            typedDst.device_time = (ice.Time_t)ice.Time_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.device_time, src, false, true, endpoint_plugin_qos);            
            
            typedDst.presentation_time = (ice.Time_t)ice.Time_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.presentation_time, src, false, true, endpoint_plugin_qos);            
...
SampleArray typedDst = (SampleArray) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            ice.ValuesTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            
            ice.Time_tTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
SampleArray typedDst = (SampleArray) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        SampleArray typedDst
            = (SampleArray) instance;
        SampleArray typedSrc
            = (SampleArray) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new SampleArrayDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new SampleArrayDataReader(native_reader, listener, mask, this);                
    ...
    protected SampleArrayTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,SampleArrayTypeCode.VALUE,SampleArray.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected SampleArrayTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,SampleArrayTypeCode.VALUE,SampleArray.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
