 ...
 * BypassObjective.
 */
public class BypassObjectiveTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::BypassObjective";
    ...
    private static final BypassObjectiveTypeSupport _singleton
        = new BypassObjectiveTypeSupport();
     ...
     */
    public static BypassObjectiveTypeSupport get_instance() {
        return _singleton;
    }

    public static BypassObjectiveTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return BypassObjective.create();
    }
     ...
     * <code>this</code> is not a <code>BypassObjective</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        BypassObjective typedDst = (BypassObjective) destination;
        BypassObjective typedSrc = (BypassObjective) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        BypassObjective typedSrc = (BypassObjective) sample;
...
BypassObjective typedSrc = (BypassObjective) src;    
        ...
        dst.writeBoolean(typedSrc.stopBypass);        
...
BypassObjective typedDst = (BypassObjective) dst;
    ...
    try {
            ...
            typedDst.stopBypass = src.readBoolean();
...
BypassObjective typedDst = (BypassObjective) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
BypassObjective typedDst = (BypassObjective) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        BypassObjective typedDst
            = (BypassObjective) instance;
        BypassObjective typedSrc
            = (BypassObjective) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new BypassObjectiveDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new BypassObjectiveDataReader(native_reader, listener, mask, this);                
    ...
    protected BypassObjectiveTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,BypassObjectiveTypeCode.VALUE,BypassObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected BypassObjectiveTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,BypassObjectiveTypeCode.VALUE,BypassObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
