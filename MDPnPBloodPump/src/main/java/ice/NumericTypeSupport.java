 ...
 * Numeric.
 */
public class NumericTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::Numeric";
    ...
    private static final NumericTypeSupport _singleton
        = new NumericTypeSupport();
     ...
     */
    public static NumericTypeSupport get_instance() {
        return _singleton;
    }

    public static NumericTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>Numeric</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        Numeric typedDst = (Numeric) destination;
        Numeric typedSrc = (Numeric) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        Numeric typedSrc = (Numeric) sample;
...
Numeric typedDst = (Numeric) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
Numeric typedDst = (Numeric) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new NumericDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new NumericDataReader(native_reader, listener, mask, this);                
    ...
    protected NumericTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,NumericTypeCode.VALUE,Numeric.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected NumericTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,NumericTypeCode.VALUE,Numeric.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
