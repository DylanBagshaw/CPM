...
/**
 * A sequence of InfusionStatus instances.
 */
public final class InfusionStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public InfusionStatusSeq() {
        super(InfusionStatus.class);
    }


    public InfusionStatusSeq(int initialMaximum) {
        super(InfusionStatus.class, initialMaximum);
    }


    public InfusionStatusSeq(Collection elements) {
        super(InfusionStatus.class, elements);
    }
