...
/**
 * A sequence of HeartBeat instances.
 */
public final class HeartBeatSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public HeartBeatSeq(int initialMaximum) {
        super(HeartBeat.class, initialMaximum);
    }


    public HeartBeatSeq(Collection elements) {
        super(HeartBeat.class, elements);
    }
