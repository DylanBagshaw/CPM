 ...
 * LongString.
 */
public class LongStringTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::LongString";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final LongStringTypeSupport _singleton
        = new LongStringTypeSupport();
     ...
     */
    public static LongStringTypeSupport get_instance() {
        return _singleton;
    }

    public static LongStringTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return LongString.create();
    }
     ...
     * <code>this</code> is not a <code>LongString</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        LongString typedDst = (LongString) destination;
        LongString typedSrc = (LongString) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        LongString typedSrc = (LongString) sample;
        ...
        currentAlignment += CdrPrimitiveType.getWstringSerializedSize(currentAlignment, typedSrc.userData);
...
LongString typedSrc = (LongString) src;    
        ...
        dst.writeWstring(typedSrc.userData,(128));                                     
...
LongString typedDst = (LongString) dst;
        
            typedDst.clear();
            typedDst.userData = src.readWstring((128));
...
LongString typedDst = (LongString) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
LongString typedDst = (LongString) sample;
    ...
    protected LongStringTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LongStringTypeCode.VALUE,LongString.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected LongStringTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,LongStringTypeCode.VALUE,LongString.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
