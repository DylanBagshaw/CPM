...
public class NumericTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[i]=new StructMember("value",false,(short)-1,false,(TypeCode)TypeCode.TC_FLOAT,5,false); i++;
        sm[i]=new StructMember("device_time",false,(short)-1,false,(TypeCode)ice.Time_tTypeCode.VALUE,6,false); i++;
        sm[i]=new StructMember("presentation_time",false,(short)-1,false,(TypeCode)ice.Time_tTypeCode.VALUE,7,false); i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("ice::Numeric",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,sm);
        return tc;
    }
}
