...
/**
 * A sequence of AlarmPriority instances.
 */
public final class AlarmPrioritySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public AlarmPrioritySeq() {
        super(AlarmPriority.class);
    }


    public AlarmPrioritySeq(int initialMaximum) {
        super(AlarmPriority.class, initialMaximum);
    }


    public AlarmPrioritySeq(Collection elements) {
        super(AlarmPriority.class, elements);
    }
