 ...
 */
public class GlobalAlarmLimitObjectiveTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::GlobalAlarmLimitObjective";
    ...
    private static final GlobalAlarmLimitObjectiveTypeSupport _singleton
        = new GlobalAlarmLimitObjectiveTypeSupport();
     ...
     */
    public static GlobalAlarmLimitObjectiveTypeSupport get_instance() {
        return _singleton;
    }

    public static GlobalAlarmLimitObjectiveTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return GlobalAlarmLimitObjective.create();
    }
    ...
    public Object create_key() {
        return new GlobalAlarmLimitObjective();
    }
    ...
    public Class get_type() {
        return GlobalAlarmLimitObjective.class;
    }
     ...
     * <code>this</code> is not a <code>GlobalAlarmLimitObjective</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        GlobalAlarmLimitObjective typedDst = (GlobalAlarmLimitObjective) destination;
        GlobalAlarmLimitObjective typedSrc = (GlobalAlarmLimitObjective) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        GlobalAlarmLimitObjective typedSrc = (GlobalAlarmLimitObjective) sample;
...
GlobalAlarmLimitObjective typedDst = (GlobalAlarmLimitObjective) dst;
...
GlobalAlarmLimitObjective typedDst = (GlobalAlarmLimitObjective) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
GlobalAlarmLimitObjective typedDst = (GlobalAlarmLimitObjective) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        GlobalAlarmLimitObjective typedDst
            = (GlobalAlarmLimitObjective) instance;
        GlobalAlarmLimitObjective typedSrc
            = (GlobalAlarmLimitObjective) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new GlobalAlarmLimitObjectiveDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new GlobalAlarmLimitObjectiveDataReader(native_reader, listener, mask, this);                
    ...
    protected GlobalAlarmLimitObjectiveTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,GlobalAlarmLimitObjectiveTypeCode.VALUE,GlobalAlarmLimitObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected GlobalAlarmLimitObjectiveTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,GlobalAlarmLimitObjectiveTypeCode.VALUE,GlobalAlarmLimitObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
