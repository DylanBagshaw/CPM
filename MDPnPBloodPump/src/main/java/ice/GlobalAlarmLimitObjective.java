...
public class GlobalAlarmLimitObjective implements Copyable, Serializable
{
    ...
    public GlobalAlarmLimitObjective() {

    }


    public GlobalAlarmLimitObjective(GlobalAlarmLimitObjective other) {
    ...
    public static Object create() {
        GlobalAlarmLimitObjective self;
        self = new GlobalAlarmLimitObjective();
    ...
    public boolean equals(Object o) {
        ...
        GlobalAlarmLimitObjective otherObj = (GlobalAlarmLimitObjective)o;
     ...
     * This method could be placed into <code>GlobalAlarmLimitObjectiveTypeSupport</code>
    ...
    public Object copy_from(Object src) {
        ...
        GlobalAlarmLimitObjective typedSrc = (GlobalAlarmLimitObjective) src;
        GlobalAlarmLimitObjective typedDst = this;
