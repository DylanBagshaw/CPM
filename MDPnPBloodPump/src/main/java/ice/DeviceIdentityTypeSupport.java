 ...
 * DeviceIdentity.
 */
public class DeviceIdentityTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::DeviceIdentity";
    ...
    private static final DeviceIdentityTypeSupport _singleton
        = new DeviceIdentityTypeSupport();
     ...
     */
    public static DeviceIdentityTypeSupport get_instance() {
        return _singleton;
    }

    public static DeviceIdentityTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>DeviceIdentity</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        DeviceIdentity typedDst = (DeviceIdentity) destination;
        DeviceIdentity typedSrc = (DeviceIdentity) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ice.ImageTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ice.ImageTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        DeviceIdentity typedSrc = (DeviceIdentity) sample;
        ...
        currentAlignment += CdrPrimitiveType.getWstringSerializedSize(currentAlignment, typedSrc.manufacturer);
            
        currentAlignment += CdrPrimitiveType.getWstringSerializedSize(currentAlignment, typedSrc.model);
            
        currentAlignment += CdrPrimitiveType.getWstringSerializedSize(currentAlignment, typedSrc.serial_number);
            
        currentAlignment += ice.ImageTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.icon);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.build);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.operating_system);
...
DeviceIdentity typedSrc = (DeviceIdentity) src;    
        ...
        dst.writeWstring(typedSrc.manufacturer,(128));                                     
            
        dst.writeWstring(typedSrc.model,(128));                                     
            
        dst.writeWstring(typedSrc.serial_number,(128));                                     
            
        ice.ImageTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.icon, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
            
        dst.writeString(typedSrc.build,(128));
            
        dst.writeString(typedSrc.operating_system,(128));
...
DeviceIdentity typedDst = (DeviceIdentity) dst;
    ...
    try {
            ...
            typedDst.manufacturer = src.readWstring((128));
            
            typedDst.model = src.readWstring((128));
            
            typedDst.serial_number = src.readWstring((128));
            
            typedDst.icon = (ice.Image)ice.ImageTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.icon, src, false, true, endpoint_plugin_qos);            
            
            typedDst.build = src.readString((128));
            
            typedDst.operating_system = src.readString((128));
...
DeviceIdentity typedDst = (DeviceIdentity) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            ice.ImageTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
DeviceIdentity typedDst = (DeviceIdentity) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        DeviceIdentity typedDst
            = (DeviceIdentity) instance;
        DeviceIdentity typedSrc
            = (DeviceIdentity) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new DeviceIdentityDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new DeviceIdentityDataReader(native_reader, listener, mask, this);                
    ...
    protected DeviceIdentityTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,DeviceIdentityTypeCode.VALUE,DeviceIdentity.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected DeviceIdentityTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,DeviceIdentityTypeCode.VALUE,DeviceIdentity.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
