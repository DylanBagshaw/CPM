...
/**
 * A sequence of ImageData instances.
 */
public final class ImageDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public ImageDataSeq() {
        super(ImageData.class);
    }


    public ImageDataSeq(int initialMaximum) {
        super(ImageData.class, initialMaximum);
    }


    public ImageDataSeq(Collection elements) {
        super(ImageData.class, elements);
    }
