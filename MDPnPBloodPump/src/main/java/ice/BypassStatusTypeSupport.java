 ...
 * BypassStatus.
 */
public class BypassStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::BypassStatus";
    ...
    private static final BypassStatusTypeSupport _singleton
        = new BypassStatusTypeSupport();
     ...
     */
    public static BypassStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static BypassStatusTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return BypassStatus.create();
    }
     ...
     * <code>this</code> is not a <code>BypassStatus</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        BypassStatus typedDst = (BypassStatus) destination;
        BypassStatus typedSrc = (BypassStatus) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        BypassStatus typedSrc = (BypassStatus) sample;
...
BypassStatus typedSrc = (BypassStatus) src;    
        ...
        dst.writeBoolean(typedSrc.bypassActive);        
            
        dst.writeDouble(typedSrc.bypass_flow_lmin);        
            
        dst.writeDouble(typedSrc.bypass_speed_rpm);        
            
        dst.writeDouble(typedSrc.blood_temp_celsius);        
            
        dst.writeDouble(typedSrc.blood_press_mmhg);        
            
        dst.writeDouble(typedSrc.volume_bypassed_ml);        
            
        dst.writeInt(typedSrc.bypass_duration_seconds);        
...
BypassStatus typedDst = (BypassStatus) dst;
...
BypassStatus typedDst = (BypassStatus) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
BypassStatus typedDst = (BypassStatus) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        BypassStatus typedDst
            = (BypassStatus) instance;
        BypassStatus typedSrc
            = (BypassStatus) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new BypassStatusDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new BypassStatusDataReader(native_reader, listener, mask, this);                
    ...
    protected BypassStatusTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,BypassStatusTypeCode.VALUE,BypassStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected BypassStatusTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,BypassStatusTypeCode.VALUE,BypassStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
