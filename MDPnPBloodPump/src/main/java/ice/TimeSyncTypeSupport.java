 ...
 * TimeSync.
 */
public class TimeSyncTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::TimeSync";
    ...
    private static final TimeSyncTypeSupport _singleton
        = new TimeSyncTypeSupport();
     ...
     */
    public static TimeSyncTypeSupport get_instance() {
        return _singleton;
    }

    public static TimeSyncTypeSupport getInstance() {
        return get_instance();
    }
     ...
     * <code>this</code> is not a <code>TimeSync</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        TimeSync typedDst = (TimeSync) destination;
        TimeSync typedSrc = (TimeSync) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        TimeSync typedSrc = (TimeSync) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.heartbeat_source);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.heartbeat_recipient);
            
        currentAlignment += ice.Time_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.source_source_timestamp);
            
        currentAlignment += ice.Time_tTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.recipient_receipt_timestamp);
...
TimeSync typedSrc = (TimeSync) src;    
        ...
        dst.writeString(typedSrc.heartbeat_source,(64));
            
        dst.writeString(typedSrc.heartbeat_recipient,(64));
            
        ice.Time_tTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.source_source_timestamp, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
            
        ice.Time_tTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.recipient_receipt_timestamp, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
TimeSync typedDst = (TimeSync) dst;
        
            typedDst.clear();
    try {

            typedDst.heartbeat_source = src.readString((64));
            
            typedDst.heartbeat_recipient = src.readString((64));
            
            typedDst.source_source_timestamp = (ice.Time_t)ice.Time_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.source_source_timestamp, src, false, true, endpoint_plugin_qos);            
            
            typedDst.recipient_receipt_timestamp = (ice.Time_t)ice.Time_tTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.recipient_receipt_timestamp, src, false, true, endpoint_plugin_qos);            
...
TimeSync typedDst = (TimeSync) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
TimeSync typedDst = (TimeSync) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new TimeSyncDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new TimeSyncDataReader(native_reader, listener, mask, this);                
    ...
    protected TimeSyncTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,TimeSyncTypeCode.VALUE,TimeSync.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected TimeSyncTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,TimeSyncTypeCode.VALUE,TimeSync.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
