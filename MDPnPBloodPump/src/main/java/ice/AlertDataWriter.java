...
/**
 * A writer for the Alert user type.
 */
public class AlertDataWriter extends DataWriterImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public InstanceHandle_t register_instance(Alert instance_data) {
        return register_instance_untyped(instance_data);
    }
    
    
    public InstanceHandle_t register_instance_w_timestamp(Alert instance_data,
    ...
    public InstanceHandle_t register_instance_w_params(Alert instance_data,
    ...
    public void unregister_instance(Alert instance_data,
                                     InstanceHandle_t handle) {
        unregister_instance_untyped(instance_data, handle);
    }
    
    
    public void unregister_instance_w_timestamp(Alert instance_data,
    ...
    public void unregister_instance_w_params(Alert instance_data,
                                             WriteParams_t params) {
    ...
    public void write(Alert instance_data, InstanceHandle_t handle) {
        write_untyped(instance_data, handle);
    }
    
    
    public void write_w_timestamp(Alert instance_data,
            InstanceHandle_t handle, Time_t source_timestamp) {
    ...
    public void write_w_params(Alert instance_data,
                               WriteParams_t params) {
    ...
    public void dispose(Alert instance_data, InstanceHandle_t instance_handle){
        dispose_untyped(instance_data, instance_handle);
    }
    
    
    public void dispose_w_timestamp(Alert instance_data,
    ...
    public void dispose_w_params(Alert instance_data,
                                 WriteParams_t params) {
    ...
    /*package*/ AlertDataWriter(long native_writer, DataWriterListener listener,
