 ...
 * LocalSimulationObjective.
 */
public class LocalSimulationObjectiveTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::LocalSimulationObjective";
    ...
    private static final LocalSimulationObjectiveTypeSupport _singleton
        = new LocalSimulationObjectiveTypeSupport();
     ...
     */
    public static LocalSimulationObjectiveTypeSupport get_instance() {
        return _singleton;
    }

    public static LocalSimulationObjectiveTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return LocalSimulationObjective.create();
    }
    ...
    public Object create_key() {
        return new LocalSimulationObjective();
    }
    ...
    public Class get_type() {
        return LocalSimulationObjective.class;
    }
     ...
     * <code>this</code> is not a <code>LocalSimulationObjective</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        LocalSimulationObjective typedDst = (LocalSimulationObjective) destination;
        LocalSimulationObjective typedSrc = (LocalSimulationObjective) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        LocalSimulationObjective typedSrc = (LocalSimulationObjective) sample;
...
LocalSimulationObjective typedDst = (LocalSimulationObjective) dst;
...
LocalSimulationObjective typedDst = (LocalSimulationObjective) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
LocalSimulationObjective typedDst = (LocalSimulationObjective) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        LocalSimulationObjective typedDst
            = (LocalSimulationObjective) instance;
        LocalSimulationObjective typedSrc
            = (LocalSimulationObjective) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new LocalSimulationObjectiveDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new LocalSimulationObjectiveDataReader(native_reader, listener, mask, this);                
    ...
    protected LocalSimulationObjectiveTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,LocalSimulationObjectiveTypeCode.VALUE,LocalSimulationObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected LocalSimulationObjectiveTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,LocalSimulationObjectiveTypeCode.VALUE,LocalSimulationObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
