...
/**
 * A sequence of Time_t instances.
 */
public final class Time_tSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public Time_tSeq(int initialMaximum) {
        super(Time_t.class, initialMaximum);
    }


    public Time_tSeq(Collection elements) {
        super(Time_t.class, elements);
    }
    ...
    public Object copy_from(Object src) {
        ...
        // copy 'new' Time_t objects (beyond the original size of this object)
