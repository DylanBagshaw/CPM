...
/**
 * A collection of useful methods for dealing with objects of type ImageData.
 */
public class ImageDataTypeSupport extends TypeSupportImpl {
	// -----------------------------------------------------------------------
	// Private Fields
	// -----------------------------------------------------------------------

	private static final String TYPE_NAME = "ice::ImageData";

	private static final char[] PLUGIN_VERSION = { 2, 0, 0, 0 };

	private static final ImageDataTypeSupport _singleton = new ImageDataTypeSupport();
	 ...
	 * of RTI Connext.
	 */
	public static ImageDataTypeSupport get_instance() {
		return _singleton;
	}

	public static ImageDataTypeSupport getInstance() {
		return get_instance();
	}
	 ...
	 *                a <code>ImageData</code> type.
	 */
	public Object copy_data(Object destination, Object source) {
		ImageData typedDst = (ImageData) destination;
		ImageData typedSrc = (ImageData) source;
	...
	public long get_serialized_sample_max_size(Object endpoint_data, boolean include_encapsulation,
		...
		currentAlignment += CdrPrimitiveType.BYTE.getSequenceMaxSizeSerialized(currentAlignment, (65530));
	...
	public long get_serialized_sample_size(Object endpoint_data, boolean include_encapsulation, short encapsulation_id,
		...
		long encapsulation_size = currentAlignment;
		ImageData typedSrc = (ImageData) sample;
		...
		currentAlignment += CdrPrimitiveType.BYTE.getSequenceSerializedSize(currentAlignment, typedSrc.userData);
...
//			dst.writeByteSeq(typedSrc.userData, (104469));
			dst.writeByteSeq(typedSrc.userData, (65530));
	...
	public Object deserialize_sample(Object endpoint_data, Object dst, CdrInputStream src,
		...
		if (deserialize_sample) {
			ImageData typedDst = (ImageData) dst;

			typedDst.clear();
			src.readByteSequence(typedDst.userData, (65530));
	...
	public Object serialized_sample_to_key(Object endpoint_data, Object sample, CdrInputStream src,
		...
		if (deserialize_key) {
			ImageData typedDst = (ImageData) sample;
	...
	protected ImageDataTypeSupport() {
		...
		super(TYPE_NAME, false, ImageDataTypeCode.VALUE, ImageData.class, TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

	}

	protected ImageDataTypeSupport(boolean enableKeySupport) {

		super(TYPE_NAME, enableKeySupport, ImageDataTypeCode.VALUE, ImageData.class, TypeSupportType.TST_STRUCT,
				PLUGIN_VERSION);
	}
}
