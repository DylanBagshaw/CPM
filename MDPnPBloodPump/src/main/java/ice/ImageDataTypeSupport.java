...
public class ImageDataTypeSupport extends TypeSupportImpl {
    ...
    private static final ImageDataTypeSupport _singleton
        = new ImageDataTypeSupport();
     ...
     * <code>this</code> is not a <code>ImageData</code>
     * type.
     */
...
ImageData typedDst = (ImageData) sample;
    ...
    protected ImageDataTypeSupport(boolean enableKeySupport) {
        ...
        super(TYPE_NAME, enableKeySupport,ImageDataTypeCode.VALUE,ImageData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
