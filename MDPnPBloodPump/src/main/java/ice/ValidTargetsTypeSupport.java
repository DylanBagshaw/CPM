 ...
 * ValidTargets.
 */
public class ValidTargetsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::ValidTargets";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};

    

    private static final ValidTargetsTypeSupport _singleton
        = new ValidTargetsTypeSupport();
     ...
     */
    public static ValidTargetsTypeSupport get_instance() {
        return _singleton;
    }

    public static ValidTargetsTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return ValidTargets.create();
    }
     ...
     * <code>this</code> is not a <code>ValidTargets</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        ValidTargets typedDst = (ValidTargets) destination;
        ValidTargets typedSrc = (ValidTargets) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getWstringSeqMaxSizeSerialized(
            currentAlignment, ((128)) + 1,((128))) ;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        ValidTargets typedSrc = (ValidTargets) sample;
        ...
        currentAlignment += CdrPrimitiveType.getWstringSeqSerializedSize(
            currentAlignment, typedSrc.userData);
...
ValidTargets typedSrc = (ValidTargets) src;    
        ...
        dst.writeWstringSeq(typedSrc.userData,(128),(128));
...
ValidTargets typedDst = (ValidTargets) dst;
...
ValidTargets typedDst = (ValidTargets) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
ValidTargets typedDst = (ValidTargets) sample;
    ...
    protected ValidTargetsTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ValidTargetsTypeCode.VALUE,ValidTargets.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected ValidTargetsTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,ValidTargetsTypeCode.VALUE,ValidTargets.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
