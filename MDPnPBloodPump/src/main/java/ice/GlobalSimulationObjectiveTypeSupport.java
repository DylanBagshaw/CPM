 ...
 * GlobalSimulationObjective.
 */
public class GlobalSimulationObjectiveTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::GlobalSimulationObjective";
    ...
    private static final GlobalSimulationObjectiveTypeSupport _singleton
        = new GlobalSimulationObjectiveTypeSupport();
     ...
     */
    public static GlobalSimulationObjectiveTypeSupport get_instance() {
        return _singleton;
    }

    public static GlobalSimulationObjectiveTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return GlobalSimulationObjective.create();
    }
    ...
    public Object create_key() {
        return new GlobalSimulationObjective();
    }
    ...
    public Class get_type() {
        return GlobalSimulationObjective.class;
    }
     ...
     * <code>this</code> is not a <code>GlobalSimulationObjective</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        GlobalSimulationObjective typedDst = (GlobalSimulationObjective) destination;
        GlobalSimulationObjective typedSrc = (GlobalSimulationObjective) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        GlobalSimulationObjective typedSrc = (GlobalSimulationObjective) sample;
...
GlobalSimulationObjective typedSrc = (GlobalSimulationObjective) src;    
        ...
        dst.writeFloat(typedSrc.jitterStep);        
            
        dst.writeFloat(typedSrc.floor);        
            
        dst.writeFloat(typedSrc.ceil);        
...
GlobalSimulationObjective typedDst = (GlobalSimulationObjective) dst;
    ...
    try {
            ...
            typedDst.jitterStep = src.readFloat();
            
            typedDst.floor = src.readFloat();
            
            typedDst.ceil = src.readFloat();
...
GlobalSimulationObjective typedDst = (GlobalSimulationObjective) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
GlobalSimulationObjective typedDst = (GlobalSimulationObjective) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        GlobalSimulationObjective typedDst
            = (GlobalSimulationObjective) instance;
        GlobalSimulationObjective typedSrc
            = (GlobalSimulationObjective) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new GlobalSimulationObjectiveDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new GlobalSimulationObjectiveDataReader(native_reader, listener, mask, this);                
    ...
    protected GlobalSimulationObjectiveTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,GlobalSimulationObjectiveTypeCode.VALUE,GlobalSimulationObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected GlobalSimulationObjectiveTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,GlobalSimulationObjectiveTypeCode.VALUE,GlobalSimulationObjective.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
