...
/**
 * A sequence of LimitType instances.
 */
public final class LimitTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public LimitTypeSeq(int initialMaximum) {
        super(LimitType.class, initialMaximum);
    }


    public LimitTypeSeq(Collection elements) {
        super(LimitType.class, elements);
    }
