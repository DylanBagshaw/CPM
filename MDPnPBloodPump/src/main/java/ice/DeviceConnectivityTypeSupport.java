 ...
 * DeviceConnectivity.
 */
public class DeviceConnectivityTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ice::DeviceConnectivity";
    ...
    private static final DeviceConnectivityTypeSupport _singleton
        = new DeviceConnectivityTypeSupport();
     ...
     */
    public static DeviceConnectivityTypeSupport get_instance() {
        return _singleton;
    }

    public static DeviceConnectivityTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return DeviceConnectivity.create();
    }
    ...
    public Class get_type() {
        return DeviceConnectivity.class;
    }
     ...
     * <code>this</code> is not a <code>DeviceConnectivity</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        DeviceConnectivity typedDst = (DeviceConnectivity) destination;
        DeviceConnectivity typedSrc = (DeviceConnectivity) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((64)) + 1);
            
        currentAlignment +=  ice.ConnectionStateTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
            
        currentAlignment +=  ice.ConnectionTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
            
        currentAlignment +=  CdrPrimitiveType.getWstringMaxSizeSerialized(currentAlignment, ((128)) + 1);
            
        currentAlignment +=  ice.ValidTargetsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=  ice.ConnectionStateTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
            
        currentAlignment +=  ice.ConnectionTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
            
        currentAlignment +=  CdrPrimitiveType.getWstringMaxSizeSerialized(currentAlignment, 1);
            
        currentAlignment +=  ice.ValidTargetsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        DeviceConnectivity typedSrc = (DeviceConnectivity) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.unique_device_identifier);
            
        currentAlignment += ice.ConnectionStateTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.state);
            
        currentAlignment += ice.ConnectionTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.type);
            
        currentAlignment += CdrPrimitiveType.getWstringSerializedSize(currentAlignment, typedSrc.info);
            
        currentAlignment += ice.ValidTargetsTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.valid_targets);
...
DeviceConnectivity typedSrc = (DeviceConnectivity) src;    
        ...
        ice.ConnectionStateTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.state, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
            
        ice.ConnectionTypeTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.type, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
            
        dst.writeWstring(typedSrc.info,(128));                                     
            
        ice.ValidTargetsTypeSupport.get_instance().serialize(endpoint_data,  typedSrc.valid_targets, dst, false, encapsulation_id,true,endpoint_plugin_qos);            
...
DeviceConnectivity typedDst = (DeviceConnectivity) dst;
    ...
    try {
            ...
            typedDst.state = (ice.ConnectionState)ice.ConnectionStateTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.state, src, false, true, endpoint_plugin_qos);            
            
            typedDst.type = (ice.ConnectionType)ice.ConnectionTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.type, src, false, true, endpoint_plugin_qos);            
            
            typedDst.info = src.readWstring((128));
            
            typedDst.valid_targets = (ice.ValidTargets)ice.ValidTargetsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.valid_targets, src, false, true, endpoint_plugin_qos);            
...
DeviceConnectivity typedDst = (DeviceConnectivity) dst;
                     ...
                     Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            ice.ConnectionStateTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            
            ice.ConnectionTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            
            src.skipWstring();
            
            ice.ValidTargetsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
DeviceConnectivity typedDst = (DeviceConnectivity) sample;
    ...
    public void key_to_instance(Object endpoint_data,
                                Object instance,
                                Object key) {
        DeviceConnectivity typedDst
            = (DeviceConnectivity) instance;
        DeviceConnectivity typedSrc
            = (DeviceConnectivity) key;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new DeviceConnectivityDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new DeviceConnectivityDataReader(native_reader, listener, mask, this);                
    ...
    protected DeviceConnectivityTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, true,DeviceConnectivityTypeCode.VALUE,DeviceConnectivity.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected DeviceConnectivityTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,DeviceConnectivityTypeCode.VALUE,DeviceConnectivity.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
