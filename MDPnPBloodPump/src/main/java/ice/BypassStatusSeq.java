...
/**
 * A sequence of BypassStatus instances.
 */
public final class BypassStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public BypassStatusSeq() {
        super(BypassStatus.class);
    }


    public BypassStatusSeq(int initialMaximum) {
        super(BypassStatus.class, initialMaximum);
    }


    public BypassStatusSeq(Collection elements) {
        super(BypassStatus.class, elements);
    }
